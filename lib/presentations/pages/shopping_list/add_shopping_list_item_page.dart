...
import 'package:kokiku/presentations/pages/shopping_list/create_new_shopping_list_item_page.dart';
...
class _AddShoppingListItemPageState extends State<AddShoppingListItemPage> {
  ...
  void _addItem() {
    ...
    Navigator.push(context, MaterialPageRoute(
        builder: (context) => CreateNewShoppingListItemPage(shoppingListId: widget.shoppingListId))
    );
  }

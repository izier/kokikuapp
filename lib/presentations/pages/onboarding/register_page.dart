...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _registerWithEmail() async {
    ...
    setState(() {
      ...
      _passwordError = password.isEmpty ? localization.translate('emptyPassword') :
      password.length < 6 ? localization.translate('passwordTooShort') : null;
    });
    ...
    try {
      ...
      showSuccessToast(
        ...
        message: localization.translate('accountCreated'),
      );
      log(jsonEncode({'userId': userId}));
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(localization.translate('have_account')),
                          TextButton(
                            onPressed: () {
